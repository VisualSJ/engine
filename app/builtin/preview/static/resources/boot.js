(function () {
    ...
    function init() {
        ...
        if (window._CCSettings) {
            window.CC_PHYISCS_CANNON = false;
            window.CC_PHYISCS_AMMO = false;
            window.CC_PHYISCS_BUILT_IN = false;

            switch (window._CCSettings.physics) {
                case 'cannon': window.CC_PHYISCS_CANNON = true; break;
                case 'ammo': window.CC_PHYISCS_AMMO = true; break;
                case 'builtin': window.CC_PHYISCS_BUILT_IN = true; break;
            }
        }
