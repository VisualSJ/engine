...
export async function load() {
    ...
    Editor.Task.addSyncTask('build-engine', Editor.I18n.t('engine.compile_engine'), Editor.I18n.t('engine.wait_quick_compile'));
    ...
    Editor.Task.removeSyncTask('build-engine');
}
