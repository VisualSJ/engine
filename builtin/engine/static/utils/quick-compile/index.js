...
Object.assign(Compiler.prototype, {
    ...
    getDstPath(path) {
        ...
        return formatPath(Path.join(this.out, Path.dirname(relative), Path.basename(relative, extname) + '.js'));
    },
...
Compiler.prototype._compileScripts = Lodash.debounce(
    Compiler.prototype._compileScripts, COMBINE_COMPILE_SCRIPTS_TIMEOUT
);
