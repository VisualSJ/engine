...
const rdr = path_.join(Manager.AssetInfo.engine, 'bin/.cache/dev/cocos/renderer/');
const { enums } = require(path_.join(rdr, 'gfx/enums'));
const rendererEnums = require(path_.join(rdr, 'enums'));
const { RenderQueue, PassStage } = require(path_.join(rdr, 'core/constants'));
