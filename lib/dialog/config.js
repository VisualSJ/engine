...
defaultConfig.info = copy(msgBase);
defaultConfig.warning = copy(msgBase);
defaultConfig.error = copy(msgBase);
...
defaultConfig.openFiles = copy(openBase);
defaultConfig.openDirectory = copy(openBase);
defaultConfig.saveFiles = copy(openBase);
...
const filterConfig = {
  ...
  scripts: {name: 'scripts',  extensions: ['ts', 'js', 'C#']},
};
