...
/**
 * 预留给 renderer.js 使用的 ipc 调用
 */
ipc.on('editor3d-lib-project:create', (event, args) => {
    return module.exports.create(args);
});

ipc.on('editor3d-lib-project:getInfo', (event, args) => {
    // TODO 这里需要正确的 returnValue 方式
    event.reply('', module.exports.getInfo(args));
});

ipc.on('editor3d-lib-project:remove', (event, args) => {
    return module.exports.remove(args);
});
