 ...
 */
const _controlMouseEvent = function (elem, detach = false) {
...
class Slider extends Base {
    ...
    */
    ...
    connectedCallback() {
        ...
        this.preci = parseInt(this.getAttribute('preci')) || mathUtils.comPreci(this.step);
        this.min = parseFloat(this.getAttribute('min')) || 0;
        // 添加监听事件
        _controlMouseEvent(this);
    ...
    static get observedAttributes() {
        return ['min', 'max', 'height', 'preci', 'step', 'value'];
    }
    ...
    get preci() {
         // 默认精度与step相同
        return parseInt(this.getAttribute('preci')) || mathUtils.comPreci(this.step);
    }
