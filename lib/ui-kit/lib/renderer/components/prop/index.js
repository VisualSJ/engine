...
let createUI = (type, data) => {
    ...
    switch (type) {
        ...
        case 'vec2':
            ...
            html = `<ui-prop type="number" label="X" value=${value.x}></ui-prop>
                <ui-prop type="number" label="Y" value=${value.y}></ui-prop>`;
            break;
        case 'vec3':
            value = JSON.parse(data);
            // html = `<ui-num-input preci="2" value=${value.x} unit="X"></ui-num-input>
            ...
            html = `<ui-prop type="number" label="X" value=${value.x}></ui-prop>
                    <ui-prop type="number" label="Y" value=${value.y}></ui-prop>
                    <ui-prop type="number" label="Z" value=${value.z}></ui-prop>`;
            break;
        case 'color3':
            value = JSON.parse(data);
...
class Prop extends Base {
    ...
    _updateUI() {
        ...
        if (this.type === 'enums') {
          ...
          if (this.type === 'vec2' || this.type === 'vec3') {
