...
class Color extends Base {
    ...
    */
    ...
    constructor() {
        ...
        //colorPicker供颜色选择
        // this.$cPickerWrap = this.shadowRoot.querySelector('#cPickerWrap');
        // this.$cPickerWrap.innerHTML = `<ui-color-picker class="color-picker" value="#ccc"></ui-color-picker>`;
     ...
     * 监听此事件触发color的cancel，并隐藏colorPicker
     */
